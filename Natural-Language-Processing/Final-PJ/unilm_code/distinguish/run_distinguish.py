...
import distinguish.distinguish_loader as distinguish_loader
...
def main():
    ...
    if args.do_train:
        ...
        bi_uni_pipeline = [distinguish_loader.Preprocess4Distinguish(args.max_pred, args.mask_prob, list(tokenizer.vocab.keys(
        ...
        train_dataset = distinguish_loader.Distinguish_Dataset(
        ...
        train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=_batch_size, sampler=train_sampler,
                                                       num_workers=args.num_workers, collate_fn=di_loader.batch_list_to_batch_tensors, pin_memory=False)
