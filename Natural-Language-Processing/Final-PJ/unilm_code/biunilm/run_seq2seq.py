...
def main():
    ...
    parser.add_argument("--bert_model", default="bert_model/model/pretrained_bert/bert-large-cased/bert-large-cased.tar.gz", type=str, required=True,
    ...
    parser.add_argument("--model_recover_path",
                        default="model/unilmv1-large-cased.bin",
                        type=str,
                        required=True,
    ...
    tokenizer = BertTokenizer.from_pretrained(
        "./bert_model/model/pretrained_bert/bert-large-cased/bert-large-cased-vocab.txt", do_lower_case=args.do_lower_case)
